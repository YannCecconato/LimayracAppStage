        ...
        <div id="menu">
                <ul class="navbar">
                    ...
                    <?php
                        ...
                        if (isset($_SESSION['email']) == false){ /** Si la session n'est pas activée */
                        ...
                        } else if ($_SESSION['idQualiteProfesseur'] == 'référent') { /** Si le professeur est un référent */
                            ...
                            echo '<li class="active"><a href="pages/gestion.php" class="a_menu"> Gestion des élèves </a></li>';
