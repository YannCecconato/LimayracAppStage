        ...
        <div id="conteneur">
            ...
            <?php
                ...
                foreach ($entreprises as $entreprise) {
                    ...
                    echo '<td><a href="modifierEleve.php?idEntreprise='. $entreprise -> getIdEntreprise() .'"> Modifier </td>';
                    echo '<td><a href="supprimerEleve.php?idEntreprise='. $entreprise -> getIdEntreprise() .'"> Supprimer </td>';
                    echo "</tr>";
